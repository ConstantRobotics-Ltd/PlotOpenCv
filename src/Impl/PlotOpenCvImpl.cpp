...
template <typename T>
void cr::utils::PlotImpl::addPlot(std::vector<T>& points, int id, int start, int end,
     cv::Scalar color, int thickness) 
{
 ...
 template <typename T>
 void cr::utils::PlotImpl::addPlot(std::vector<std::vector<T>>& points, int id, int start, int end,
    cv::Scalar color, int thickness)
{
    // Check if id is already contained.
    for (const auto& pair : m_plots)
...
cr::utils::PlotImpl::Plot2D::Plot2D(std::vector<double>& points, int id,
...
cr::utils::PlotImpl::Plot2D::Plot2D(std::vector<std::vector<double>>& points, int id,
                     int start, int end, cv::Scalar color, int thickness)
{
...
template void cr::utils::PlotImpl::addPlot(std::vector<float>& Points, int id,
                            int start, int end, cv::Scalar color, int thickness);
template void cr::utils::PlotImpl::addPlot(std::vector<double>& Points, int id,
                            int start, int end, cv::Scalar color, int thickness);
template void cr::utils::PlotImpl::addPlot(std::vector<int>& Points, int id,
                            int start, int end, cv::Scalar color, int thickness);
template void cr::utils::PlotImpl::addPlot(std::vector<short int>& Points, int id,
                            int start, int end, cv::Scalar color, int thickness);
template void cr::utils::PlotImpl::addPlot(std::vector<unsigned short int>& Points, int id,
                            int start, int end, cv::Scalar color, int thickness);
template void cr::utils::PlotImpl::addPlot(std::vector<unsigned int>& Points, int id,
                            int start, int end, cv::Scalar color, int thickness);
template void cr::utils::PlotImpl::addPlot(std::vector<char>& Points, int id,
                            int start, int end, cv::Scalar color, int thickness);
template void cr::utils::PlotImpl::addPlot(std::vector<unsigned char>& Points, int id,
                            int start, int end, cv::Scalar color, int thickness);


template void cr::utils::PlotImpl::addPlot(std::vector<std::vector<float>>& Points, int id,
                            int start, int end, cv::Scalar color, int thickness);
template void cr::utils::PlotImpl::addPlot(std::vector< std::vector<double>>& Points, int id,
                            int start, int end, cv::Scalar color, int thickness);
template void cr::utils::PlotImpl::addPlot(std::vector< std::vector<int>>& Points, int id,
                            int start, int end, cv::Scalar color, int thickness);
template void cr::utils::PlotImpl::addPlot(std::vector< std::vector<short int>>& Points,int id,
                            int start, int end, cv::Scalar color, int thickness);
template void cr::utils::PlotImpl::addPlot(std::vector< std::vector<unsigned short int>>& Points,
                            int id, int start, int end,
                            cv::Scalar color, int thickness);
template void cr::utils::PlotImpl::addPlot(std::vector< std::vector<unsigned int>>& Points,
                            int id, int start, int end,
                            cv::Scalar color, int thickness);
template void cr::utils::PlotImpl::addPlot(std::vector< std::vector<char>>& Points, int id,
                            int start, int end,
                            cv::Scalar color, int thickness);
template void cr::utils::PlotImpl::addPlot(std::vector< std::vector<unsigned char>>& Points,
                            int id, int start, int end,
                            cv::Scalar color, int thickness);